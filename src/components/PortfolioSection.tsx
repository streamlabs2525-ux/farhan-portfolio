            ...
            <div className="w-full max-w-7xl mx-auto px-6 lg:px-12">
                ...
                {loading ? (
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                        {[1, 2, 3].map((i) => (
                            <div key={i} className="animate-pulse bg-[#111] h-[500px] rounded-xl" />
                        ))}
                    </div>
                ) : (
                    <motion.div
                        className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 w-5xl mx-auto"
                        initial={{ opacity: 0 }}
                                ...
                                >
                                    ...
                                    <div className="absolute bottom-0 left-0 w-full p-6 z-10 flex justify-between items-end translate-y-4 group-hover:translate-y-0 transition-transform duration-300">
                                        <div>
                                            ...
                                            <p className="text-sm text-neutral-400 capitalize">{project.description}</p>
                                        </div>
